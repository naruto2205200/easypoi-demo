...
public class ExcelUtils {
     ...
     * @param response
     */
    public static void exportExcel(List<ExcelExportEntity> entityList, List<?> list,String title, String sheetName, String fileName, HttpServletResponse response) throws IOException {
        defaultExport(entityList,list, fileName, response, new ExportParams(title, sheetName, ExcelType.XSSF));
    }
     ...
     * @param exportParams 导出参数
     */
    private static void defaultExport(List<ExcelExportEntity> entityList,List<?> list, String fileName, HttpServletResponse response, ExportParams exportParams) throws IOException {

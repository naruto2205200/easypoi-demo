 ...
 */
@Data
@ExcelTarget("teacherAndStuEntity")
public class TeacherAndStuEntity implements Serializable {
    public TeacherAndStuEntity(){

    }

    public TeacherAndStuEntity(String id, String subName) {
        this.id=id;
